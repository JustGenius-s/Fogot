...
export function getPlanSystemPrompt(): string {
  ...
  return [
    ...
    '',
    '## Plan File',
    'Compose your plan directly in your reply text using Markdown. When ready, call exit_plan_mode with the full plan content. No files need to be written.',
    '',
    '## Plan Workflow',
    '',
    ...
    '',
    '### Phase 4: Final Plan',
    'Goal: Compose your final plan as a Markdown document in your reply.',
    '- Write the plan as a clear Markdown document',
