...
const toolGroupVariants = cva("aui-tool-group-root group/tool-group mt-3 mb-4 w-full", {
  variants: {
    variant: {
    ...
    >
      <div
        className={cn(
          ...
          "group-data-[variant=ghost]/tool-group-root:mt-1 group-data-[variant=ghost]/tool-group-root:gap-1 group-data-[variant=ghost]/tool-group-root:pl-5",
