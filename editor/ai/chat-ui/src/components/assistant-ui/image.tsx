...
function ImageRoot({
  ...
  return (
    <div className={cn(imageVariants({ variant, size, className }))} {...props}>
      {children}
    </div>
  );
}
...
function ImagePreview({
  ...
  return (
    ...
    >
      ...
      {error ? (
        <div className="flex min-h-32 items-center justify-center gap-2 p-4 text-muted-foreground">
...
function ImageFilename({
  ...
  return (
    <span
      ...
      className={cn(
        "block truncate px-2.5 py-1.5 text-xs text-muted-foreground",
        className,
      )}
      {...props}
    >
...
function ImageGenerating({ className }: { className?: string }) {
  return (
    <div
      className={cn(
        "flex min-h-48 items-center justify-center gap-2 p-4 text-muted-foreground",
        className,
      )}
    >
...
function ImageContentFilterError({
  ...
  return (
    <div
      className={cn(
        "flex min-h-32 flex-col items-center justify-center gap-1 p-4 text-muted-foreground",
        className,
      )}
    >
      <ShieldAlertIcon className="size-6" />
      <span className="text-sm font-medium">Image could not be generated</span>
      {reason && (
...
function ImageActions({ part, className }: ImageActionsProps) {
  return (
    <div
      data-slot="image-actions"
      className={cn(
        "flex items-center gap-0.5 px-2 py-1 text-muted-foreground",
        className,
      )}
    >
      <button
