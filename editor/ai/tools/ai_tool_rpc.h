...
/// Export a design doc's frontmatter into a typed Godot Resource (.tres).
/// Args: tres_path (output res:// path), script_path (per-kind Resource script,
///       generated by the frontend from the design schema), fields (JSON object
///       of frontmatter values). Instantiates the script, sets exported
///       properties from the fields, and saves the resource.
String design_export_resource(const Dictionary &p_args);
